...
import renderingEngine.TextureData;
...
public class Loader {
	...
	public int loadGuiTexture(String fileName)
	{
		Texture texture = null;
		try {
			texture = TextureLoader.getTexture("PNG", new FileInputStream("guis/"+fileName+".png"));
			GL30.glGenerateMipmap(GL11.GL_TEXTURE_2D);
			GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MIN_FILTER, GL11.GL_LINEAR_MIPMAP_LINEAR);
	...
	public int loadCubeMap(String[] textureFiles)
	{
		...
		{
			TextureData data = decodeTextureFile("resources/images/" + textureFiles[i] + ".png");
